...
\Final_project.ipynb Jupiter notebook contains the code for Sentiment Classification and Recommender Systems
...
Heroku Link : https://recommedate.herokuapp.com/

Github Link : https://github.com/zatanite/Sentiment-based-Product-Recommendation
